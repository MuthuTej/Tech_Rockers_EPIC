    ...
    <div className="space-y-5">
      ...
      <div className="liq-card p-4 grid grid-cols-3 gap-4">
        ...
        <Stat
          ...
          color={totals.diff > 0 ? '#EF4444' : '#86efac'}
        />
      </div>
                    ...
                    <Td className="text-right">
                      {b.actualHours === 0 ? (
                        ...
                        <span className="inline-flex items-center gap-1 text-xs font-semibold"
                          style={{ color: isOver ? '#EF4444' : '#86efac' }}>
                      ...
                      <Td>
                        {isEditing ? (
                          <div className="flex gap-1">
                            <button onClick={() => saveEdit(b)} className="p-1.5 rounded text-[#86efac] hover:bg-white/5"><Check size={14} /></button>
